...
def main(argv):
    ...
    logging.debug("xml2rdf_morph.py: openopps_mapping_filename = " + openopps_mapping_filename)
    logging.debug("xml2rdf_morph.py: opencorporates_mapping_filename = " + opencorporates_mapping_filename)
            ...
            for filename in os.listdir(dirPath):
                ...
                if is_openopps_json(filename):
                    ...
                    config_morph = """
                            ...
                            mappings=""" + rml_folder + "/" + openopps_mapping_filename
                ...
                if is_opencorporates_json(filename):
                    ...
                    config_morph = """
                            [DataSourceXML]
                            file_path=""" + dirPath + "/" + filename +"""
                            mappings=""" + rml_folder + "/" + opencorporates_mapping_filename
